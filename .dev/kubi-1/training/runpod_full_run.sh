...
CPT_HF_REPO="${CPT_HF_REPO:-atilladeniz/kubi1-cpt-adapter}"
...
SFT_HF_REPO="${SFT_HF_REPO:-atilladeniz/kubi1-gguf}"
...
hf download "${CPT_HF_REPO}" --dry-run >/dev/null
hf download atilladeniz/kubi1-cpt-corpus --repo-type dataset --dry-run >/dev/null
hf download atilladeniz/kubi1-sft-dataset --repo-type dataset --dry-run >/dev/null
