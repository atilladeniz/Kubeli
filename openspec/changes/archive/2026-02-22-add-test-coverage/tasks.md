...
- [x] `diagram-store.test.ts` - Diagram state (22 tests)
- [x] `resource-store.test.ts` - Resource caching (23 tests)
- [x] `favorites-store.test.ts` - Favorites management (24 tests)
