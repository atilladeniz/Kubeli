...
## Purpose
Provide structured, actionable error handling across the Rust backend and React frontend, replacing generic string errors with typed error objects that enable smart retry behavior and user-friendly display.
