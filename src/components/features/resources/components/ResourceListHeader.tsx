...
export function ResourceListHeader<T>({
  ...
  return (
    <div className="@container border-b border-border">
      <div className="flex flex-wrap items-center justify-between gap-2 @2xl:gap-3 px-3 @2xl:px-4 py-2 @2xl:py-3">
        <div className="flex items-center gap-2 @2xl:gap-3 min-w-0 flex-wrap">
        ...
        <div className="flex flex-wrap items-center gap-1.5 @2xl:gap-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="w-40 @2xl:w-56 pl-8 pr-8"
            />
          ...
          {onStartWatch && onStopWatch && (
            <Button
              ...
              title={isWatching ? t("watch.watching") : t("watch.watch")}
            >
              <Radio
