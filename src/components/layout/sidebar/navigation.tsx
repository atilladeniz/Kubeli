    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "admission-policies", label: t("admissionPolicies"), icon: <ShieldCheck className={iconClass} /> },
          { id: "admission-policy-bindings", label: t("admissionPolicyBindings"), icon: <Link2 className={iconClass} /> },
        ],
      },
    ],
    [t],
