...
const cases: TestCase[] = [
  ...
  { name: "listValidatingAdmissionPolicies", run: () => resources.listValidatingAdmissionPolicies(), expectedCommand: "list_validating_admission_policies" },
  { name: "listValidatingAdmissionPolicyBindings", run: () => resources.listValidatingAdmissionPolicyBindings(), expectedCommand: "list_validating_admission_policy_bindings" },
